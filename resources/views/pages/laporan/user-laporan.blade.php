 ...
 <!--                <li><a href="news.html">News</a></li>
    ...
    <div class="site-section site-hero">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-10">
            <span class="d-block mb-3 caption" data-aos="fade-up" data-aos-delay="200">Pengaduan Layanan Masyarakat</span>
            <textarea style="width:400px;   height: 200px; text-align: center; align-content: center;" >Masukan Laporan</textarea>
